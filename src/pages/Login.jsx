        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: 'var(--bg-dark)' }}>
            <div className="card" style={{ width: '100%', maxWidth: '400px' }}>
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    ...
                    <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Bem-vindo de volta</h1>
                    <p style={{ color: 'var(--text-muted)' }}>Faça login para gerenciar seus ganhos</p>
                </div>
                ...
                <div style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.875rem', color: 'var(--text-muted)' }}>
                    Não tem uma conta? <Link to="/register" style={{ color: 'var(--primary)', fontWeight: '600' }}>Crie agora</Link>
                </div>
            </div>
        </div>
    );
